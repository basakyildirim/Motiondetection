...
while True: 
    ...
    if motion_list[-1] == 1 and motion_list[-2] == 0:
        ...
        data = urllib.urlopen("************************************"+timestart);
        data2= urllib.urlopen("**********************************"+"Misafiriniz Var! :"+timestart);
        time.sleep(8.0)
        mail("********************","Merhaba bu mail Raspberry'den geldi","Misafir Var!",'/home/pi/Desktop/%s.jpg'%(timestart))
